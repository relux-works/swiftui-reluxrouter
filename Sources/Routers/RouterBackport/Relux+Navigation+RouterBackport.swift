...
extension Relux.Navigation {
    ...
    public final class RouterBackport<Page>: Relux.Navigation.RouterProtocol, Relux.HybridState, Observable
...
extension Relux.Navigation.RouterBackport {
	...
	public func reduce(with action: any Relux.Action) async {
        switch action as? Relux.Navigation.RouterBackport<Page>.Action {
			case .none: break
