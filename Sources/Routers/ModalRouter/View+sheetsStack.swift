...
extension View {
    ...
    ) -> some View where Page: Relux.Navigation.ModalComponent & Sendable {
        modifier(
            ModalStackModifier(
                router: router,
...
@available(iOS 17, macOS 14, watchOS 10, tvOS 17, macCatalyst 17, *)
private struct ModalStackModifier<Page: Relux.Navigation.ModalComponent & Sendable, InternalContent: View>: ViewModifier {
