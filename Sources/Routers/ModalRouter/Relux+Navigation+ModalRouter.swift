...
extension Relux.Navigation {
    ...
    /// plus optional state restoration to `UserDefaults`.
    @Observable @MainActor
    public final class ModalRouter<Page>: Relux.Navigation.ModalRouterProtocol, Observable
    where Page: ModalComponent & Sendable & Codable {
...
// MARK: - Safe Collection/Mutation Helpers
